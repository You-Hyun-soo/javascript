...
// 토글은 프로그래밍 개념
// 오직 2개의 값을 가지고 있는 상태
// 하나를 선택하면 다른 하나는 선택이 안된다.
// 스위치 개념
var btn1 = doc.getElementById('btn1');

// btn1.addEventListener('mousedown',event1); // 마우스를 눌렀을 때
//btn1.addEventListener('mouseup',event2); // 마우스를 땠을 때
...
function event1(){ // 콜백함수 -> (이벤트)후에 실행
